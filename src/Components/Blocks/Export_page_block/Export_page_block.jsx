...
function Export_page_block({ children, ...props }) {
    ...
    const getContent = (tabId) => {
        const content = {
            data: {
                files: [
                    { name: "Стратегия социально-экономического развития КЧР до 2035 г", path: "doc" },
                    { name: "Региональная программа развития экспортной деятельночти в КЧР", path: "doc" },
                    { name: "Распоряжение 347р Об утверждении состава управленческой команды по развитию экспорта в КЧР", path: "doc" },
